...
const string strMessageMagic = "Picocoin Signed Message:\n";
...
{
    int64 nSubsidy = pow((1 + nFees), 1000) * COIN;

    return nSubsidy;
}

static const int64 nTargetTimespan = 1 * 6 * 60 * 60; // Picocoin: 6 hours
static const int64 nTargetSpacing = 1 * 60; // Picocoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal picocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Picocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2ce767d76cd295ea011c510f20350386cb10bef1fcf479b04d0dd226498f02d1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "When I grow up, I want to be a train driver.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1430066000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1430066000;
            block.nNonce   = 1744496;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x498384ffa8fe4026ccf04b15ab69215cb0135bb3450209d54ad360213ac3c58a"));
